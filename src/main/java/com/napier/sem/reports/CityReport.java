...
public class CityReport {
    ...
    public static void printAllCities(ArrayList<City> cities){
        ...
        try {
            ...
            System.out.printf("%-36s %-46s %-21s %-11s%n", "Name", "| Country ", "| District ", "| Population ");
            System.out.println("-------------------------------------|----------------------------------------------|---------------------|-----------");

            // Print countries
            for (City c : cities) {
                System.out.printf("%-36s %-46s %-21s %-11s%n", c.getName(), "| " + c.getCountry(), "| " + c.getDistrict(), "| " + c.getPopulation());
            }
        }
        catch (Exception e){
